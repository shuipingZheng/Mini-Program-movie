...
Page({
    ...
    wx.getSetting({
      success(res) {
        ...
        if (res.authSetting['scope.userLocation']){
          ...
          _this.setData({
            failLocation: '定位失败，请点击重试'
          })
        }
        _this.setData({
          isLocation: res.authSetting['scope.userLocation']
        })
      }
    })
    this.getCity();
  ...
  citySelected: function (e) {
    ...
    // }
    // app.globalData.selectedCity = cityNameTemp;
    wx.setStorageSync('locationCity', cityNameTemp);
   ...
   */
  onShow: function () {
    if (this.data.isReady && this.data.isLocation){
      this.getCity();
    }
  ...
  getCity: function(){
    ...
    wx.getLocation({
      success: function (res) {
        ...
        util.requestLocation(_this, locationString, false);
        _this.setTitle();
      }
    })
